...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface &planning_scene_interface)
{
    ...
    collision_objects[1].primitives[0].dimensions = {0.8, 1.5 ,1.015};
    ...
    collision_objects[2].primitives[0].dimensions = {0.8, 1.5, 1.015};
...
int main(int argc, char **argv)
{
  ...
  // Open Gripper
    ...
    move_group_robot.setPoseTarget(target_pose2);
    // move_group_robot.setPathConstraints()
    ...
    move_group_gripper.setNamedTarget("open");
    // move_group_gripper.setJointValueTarget(move_group_gripper.getNamedTargetValues("open"));
